        ...
        NavigationStack {
            ...
            .toolbar {
                ...
                ToolbarItem(placement: .confirmationAction) {
                    Button("Save") {
                        var entry = SessionEntry(title: title, detail1: detail1, detail2: detail2, note: note, date: date)
