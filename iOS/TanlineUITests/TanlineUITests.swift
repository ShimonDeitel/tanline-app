...
final class TanlineUITests: XCTestCase {
    ...
    func testAddEntryFlow() {
        ...
        titleField.tap()
        titleField.typeText("New Session")
        app.buttons["saveButton"].tap()
        XCTAssertTrue(app.staticTexts["New Session"].waitForExistence(timeout: 2))
    }
    ...
    func testKeyboardDismissesOnTapOutside() {
        ...
        app.staticTexts["Add Session"].tap()
